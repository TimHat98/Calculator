  ...
  internal class Program
  {
    static void Main(string[] args)
    {
      ...
      while (again != 'n')
      {
        ...
        Console.WriteLine("Хотите совершить еще одно действие? Нажмите y для продолжения, n для выхода\n");
        var answer = Console.ReadLine();
        var test = Convert.ToChar(answer);
        ...
        {
          Console.WriteLine("Неверный ввод, до свидания\n");
          again = 'n';
        }
      }
    }
